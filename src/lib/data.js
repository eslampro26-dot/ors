...
export const cities = [
  ...
  {
    id: "dahab",
    nameAr: "دهب والعين السخنة",
    nameEn: "Dahab & Ain Sokhna",
    slug: "dahab",
    emoji: "⛺",
    image: "https://images.unsplash.com/photo-1533105079780-92b9be482077?auto=format&fit=crop&w=800&q=80",
    descriptionAr: "سحر سيناء والساحل - تجربة مصرية أصيلة بين الجبال والبحر الهادئ",
    descriptionEn: "Sinai & Coast Magic - An authentic Egyptian experience combining mountain camps and beach relaxation",
    names: {
      en: "Dahab & Ain Sokhna",
      ar: "دهب والعين السخنة",
      de: "Dahab & Ain Sokhna",
      fr: "Dahab et Ain Sokhna",
      es: "Dahab y Ain Sokhna",
      it: "Dahab e Ain Sokhna",
      ru: "Дахаб и Айн-Сохна",
      tr: "Dahab ve Ain Sokhna",
      zh: "达哈卜与艾因苏赫纳",
      ja: "ダハブ & アイン・ソフナ"
    },
    descriptions: {
      en: "Sinai & Coast Magic - An authentic Egyptian experience combining mountain camps and beach relaxation",
      ar: "سحر سيناء والساحل - تجربة مصرية أصيلة بين الجبال والبحر الهادئ",
      de: "Sinai & Küstenmagie - Ein authentisches ägyptisches Erlebnis, das Berglager und Strandentspannung verbindet",
      fr: "Magie du Sinaï et de la côte - Une expérience égyptienne authentique combinant camps de montagne et détente sur la plage",
      es: "Magia del Sinaí y de la costa: una auténtica experiencia egipcia que combina campamentos de montaña y relajación en la playa",
      it: "Magia del Sinai e della Costa - Un'autentica esperienza egiziana che unisce campeggi in montagna e relax in spiaggia",
      ru: "Магия Синая и побережья - аутентичный египетский опыт, сочетающий горные лагеря и отдых на пляже",
      tr: "Sina ve Sahil Sihri - Dağ kampları ve plaj rahatlamasını birleştiren otantik bir Mısır deneyimi",
      zh: "西奈与海岸魔力 - 结合山地宿营和海滩休闲的真实埃及体验",
      ja: "シナイ & コースト・マジック - マウンテンキャンプとビーチリラクゼーションを組み合わせた本物のエジプト体験"
    },
    categories: [
      { id: "packages", slots: 20 },
      { id: "sea-trips", slots: 20 },
      { id: "desert-trips", slots: 20 },
      { id: "restaurants", slots: 20 },
      { id: "cafes", slots: 20 },
