...
const adminLabels = {
  ...
  ar: {
    ...
    bookings: 'الحجوزات',
    reports: 'التقارير',
    backups: 'النسخ الاحتياطي والاسترجاع',
    settings: 'الإعدادات',
  ...
  de: {
    ...
    bookings: 'Buchungen',
    reports: 'Berichte',
    backups: 'Sicherungen & Wiederherstellung',
  ...
  tr: {
    ...
    reports: 'Raporlar',
    backups: 'Yedekleme ve Geri Yükleme',
    settings: 'Ayarlar',
...
export default function AdminLayout({ children }) {
  ...
  const navItems = [
    ...
    { name: aL.backups, href: '/orluxus-management/backups', icon: '💾' },
