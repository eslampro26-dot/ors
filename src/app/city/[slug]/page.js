...
export default function CityPage() {
  ...
  return (
    <main style={{ minHeight: '100vh', paddingBottom: '4rem', background: 'transparent' }}>
      ...
      {/* 1.5 CITY TRAVEL GUIDE PREVIEW SECTION */}
      {article && (
        <div className="container animate-fade-in-up" style={{ marginTop: '4rem' }}>
          <div style={{
            ...
            {/* Elegant luxury gold background pattern */}
            <div style={{
              position: 'absolute',
              top: 0,
              ...
              width: '180px',
              height: '100%',
              background: 'linear-gradient(to right, rgba(201, 162, 39, 0.04), transparent)',
              pointerEvents: 'none',
            ...
            <div style={{ position: 'relative', zIndex: 2 }}>
              <span style={{ 
                ...
                {locale === 'ar' ? 'كشف معالم وتاريخ المدينة' : 'EXPLORE HERITAGE & HISTORY'}
              </span>
              <h3 style={{ 
                ...
                {locale === 'ar' ? `دليل السفر الشامل لمدينة ${locCity.name}` : `Complete Travel Guide for ${locCity.name}`}
              </h3>
              <p style={{ 
