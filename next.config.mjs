        ...
        headers: [
          ...
          { key: 'X-Content-Type-Options', value: 'nosniff' },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.firebaseio.com https://*.googleapis.com https://*.firebasestorage.app https://www.paypal.com https://firestore.googleapis.com https://*.firestore.googleapis.com",
